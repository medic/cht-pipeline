SELECT
	...
	-- assess.fever_duration,
	-- assess.diarrhea_duration,
	-- assess.cough_duration,
	
	-- greatest(assess.fever_duration,assess.diarrhea_duration,assess.cough_duration) AS max_symptom_duration,
	-- CASE
	-- 	WHEN assess.max_symptom_duration = 0 THEN 'none'::text
	-- 	WHEN assess.diarrhea_duration = assess.max_symptom_duration
	-- 		AND assess.fever_duration <> assess.max_symptom_duration
	-- 		AND assess.cough_duration <> assess.max_symptom_duration THEN 'diarrhea'::text
	-- 	WHEN assess.diarrhea_duration <> assess.max_symptom_duration
	-- 		AND assess.fever_duration = assess.max_symptom_duration
	-- 		AND assess.cough_duration <> assess.max_symptom_duration THEN 'fever'::text
	-- 	WHEN assess.diarrhea_duration <> assess.max_symptom_duration
	-- 		AND assess.fever_duration <> assess.max_symptom_duration
	-- 		AND assess.cough_duration = assess.max_symptom_duration THEN 'cough'::text
	-- 	ELSE 'multiple'
	-- END AS max_symptom_type,
...
WHERE
	...
	AND assess.patient_age_in_months < 60
