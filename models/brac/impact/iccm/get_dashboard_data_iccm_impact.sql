...
SELECT
	...
	SAFE_DIVIDE(SUM(COALESCE(assess_count.count_ax_within_24,0)),SUM(COALESCE(assess_count.count_u5_ax,0)),2) AS percent_ax_within_24,
	SAFE_DIVIDE(SUM(COALESCE(assess_count.count_ax_within_48,0)),SUM(COALESCE(assess_count.count_u5_ax,0)),2) AS percent_ax_within_48,
	SAFE_DIVIDE(SUM(COALESCE(assess_count.count_ax_within_72,0)),SUM(COALESCE(assess_count.count_u5_ax,0)),2) AS percent_ax_within_72,
	SAFE_DIVIDE(SUM(COALESCE(assess_count.count_ax_beyond_72,0)),SUM(COALESCE(assess_count.count_u5_ax,0)),2) AS percent_ax_beyond_72,
